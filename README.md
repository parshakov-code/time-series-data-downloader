...
TSD is provided as a single Jupyter Notebook and installs all required libraries automatically. The notebook includes detailed explanations of all parameters and workflow steps, with further discussion available in the technical note referenced below.
